<script>
	...
	let task_quiz_sequence = {
		...
		"Task_2": {activation: (arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8) => arg0, time_limit_seconds: 60, randomize_arg_order: true, noise:0}
	}
...
{#key current_task_quiz}
	...
	{:else if JSON.stringify(Object.keys(current_task_quiz)) == JSON.stringify(["quiz_bit_combos"])}
		<Quiz {...current_task_quiz} on:continue={handleContinue}/>
	{:else}
		<TaskVid/>
	{/if}
{/key}