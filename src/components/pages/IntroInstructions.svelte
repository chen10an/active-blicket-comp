<script>
    ...
    import { FADE_DURATION_MS, FADE_IN_DELAY_MS, block_dict, bonus_currency_str, max_total_bonus, intro_cont_clicks } from '../../modules/experiment_stores.js';
...
{:else if checking_page_num === 2}
                <div in:fade="{{delay: FADE_IN_DELAY_MS, duration: FADE_DURATION_MS}}" class="middle-centering-div">
                    <p>TODO: blicket rating practice captcha</p>
                    <button on:click="{cont}">Continue</button>
                    <div class:hide={!show_feedback}>
